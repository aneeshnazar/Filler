...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/23 18:49:03 by anazar            #+#    #+#             */
/*   Updated: 2017/10/23 18:58:42 by anazar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		*get_corners(t_piece piece)
{
	...
	arr[0] = 0;
	arr[3] = len - 1;
	arr[1] = get_tr_corner(tmp_ind[arr[0]] / piece.y_len,
				tmp_ind, piece.y_len);
	arr[2] = get_bl_corner(tmp_ind[arr[3]] / piece.y_len - 1,
				tmp_ind, piece.y_len);
	return (arr);
}
